...
public class CellRenderer extends DefaultTableCellRenderer {
  ...
  public CellRenderer() {
    ...
    selectedField.setFont(selectedField.getFont().deriveFont(Font.PLAIN, 12));
    selectedField.setOpaque(true);
    selectedFocusField.setBackground(Color.DARK_GRAY);
    selectedFocusField.setForeground(Color.WHITE);
    selectedFocusField.setFont(selectedFocusField.getFont().deriveFont(Font.PLAIN, 12));
    ...
    selectedFocusInitField.setFont(selectedFocusInitField.getFont().deriveFont(Font.PLAIN, 12));
