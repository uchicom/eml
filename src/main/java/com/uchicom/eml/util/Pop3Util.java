...
public class Pop3Util {
   ...
   * @throws IOException
   */
  public static boolean login(BufferedReader br, PrintStream ps, String username, String password)
      throws IOException {
  ...
  public static String uidl(BufferedReader br, PrintStream ps, int index) throws IOException {
    ps.print("UIDL " + index + "\r\n");
    ps.flush();
    String line = br.readLine();
  ...
  public static List<String> uidl(BufferedReader br, PrintStream ps) throws IOException {
    ps.print("UIDL\r\n");
    ps.flush();
    String line = br.readLine();
